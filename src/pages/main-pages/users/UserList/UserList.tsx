  ...
  return (
    <div className="p-4">
      <div className="bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden">
        ...
        {/* Shadcn Dialog for Filter */}
      <Dialog open={filterOpen} onOpenChange={setFilterOpen}>
        <DialogContent
          className="fixed top-0 right-0 h-full w-100 p-6 bg-white shadow-lg border-l border-gray-200 rounded-l-lg overflow-auto"
          style={{ animation: filterOpen ? "slideIn 0.3s forwards" : "slideOut 0.3s forwards" }}
        >
          <DialogHeader>
            <DialogTitle>Filter Users</DialogTitle>
            <DialogDescription>
              Apply filters to narrow down user list.
            </DialogDescription>
          </DialogHeader>
      ...
      {/* Add slideIn/slideOut keyframes in global styles (tailwind config or global css) */}
      <style>{`
        @keyframes slideIn {
          from {
